...
namespace com.reallifeministries.Workflow
{
    ...
    /// </summary>
    [DisplayName( "Advanced Workflow Entry" )]
    [Category( "WorkFlow" )]
    ...
    public partial class AdvancedWorkflowEntry : Rock.Web.UI.RockBlock, IPostBackEventHandler
    {
        #region Fields
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                if ( HydrateObjects() )
                {
                    // Added by Nik Petersen Apr 22 2015.
                    // Add workflow instance to http context for use with context aware fields.
                    System.Web.HttpContext.Current.Items["Workflow"] = _workflow;
                    // Add workflow activity instance to http context for use with context aware fields.
                    System.Web.HttpContext.Current.Items["WorkflowActivity"] = _activity;
